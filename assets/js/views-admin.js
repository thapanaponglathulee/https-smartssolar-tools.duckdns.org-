...
(function () {
  ...
  var MAP = [
    ...
    ['CI-22', 'ประวัติเช็คอิน กำหนดช่วงที่แสดงและแบ่งหน้า', '—', 'todo', 'UAT FB-12 · ยังไม่ทำในรอบนี้'],
    ['CI-23', 'ค้นหาและกรองประวัติเช็คอินตามช่วงวันที่', '—', 'todo', 'UAT FB-13 · ยังไม่ทำในรอบนี้'],
    ['CI-24', 'สรุปของตัวเองสำหรับพนักงาน', 'หน้าเช็คอิน — บล็อกสรุปย่อด้านล่าง', 'partial', 'UAT FB-15 · ยังไม่ครบทุกหัวข้อตามสเปก'],
    ['CI-25', 'ไปหลายไซต์ในวันเดียว ไซต์หลักหนึ่ง แวะเพิ่มได้', '—', 'todo', 'ยังไม่ทำในรอบนี้'],
    ...
    ['CI-28', 'เก็บพิกัดตอนเช็คอิน', '—', 'todo', 'ยังไม่ทำในรอบนี้'],
